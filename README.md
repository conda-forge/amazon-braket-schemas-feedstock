...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/amazon-braket-schemas-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13918&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/amazon-braket-schemas-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `amazon-braket-schemas` can be installed with:

```
conda install amazon-braket-schemas
```

It is possible to list all of the versions of `amazon-braket-schemas` available on your platform with:
